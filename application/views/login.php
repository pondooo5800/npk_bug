    ...
    <body>
        <div id="wrapper">
            <div class="login" style="background-color: inherit">
                ...
                <h3 style="font-size: 14px;color: #f3f4f7 !important;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;" class="text-center">© สงวนลิขสิทธ์โดย สำนักงานเทศบาลตำบลหนองป่าครั่ง พัฒนาโดย บริษัท จิ๊กซอว์ อินโนเวชั่น จำกัด เวอร์ชั่น 1.0</h3>
            </div>
        </div>
    </body>
